        ...
        <div className="why-grid">
          ...
          <div className="why-copy">
            ...
            <ul className="feature-list">
              <li><span className="tick">✓</span> Organized, verified temple information</li>
              <li><span className="tick">✓</span> AI-powered pilgrimage planning</li>
              <li><span className="tick">✓</span> Personalized recommendations</li>
              <li><span className="tick">✓</span> Festival and darshan-season guidance</li>
              <li><span className="tick">✓</span> Practical visitor and travel insights</li>
              <li><span className="tick">✓</span> Coverage across {stateCount}+ Indian states</li>
            </ul>
